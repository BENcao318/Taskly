...
export const EditClientModalForm = ({ setOpenEditClientModal }) => {
  ...
  return (
    <form className="w-full ">
      ...
      <div className="flex items-center justify-center mt-6">
        <button
          type="submit"
          className="w-full px-6 py-2 font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 text-md sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
